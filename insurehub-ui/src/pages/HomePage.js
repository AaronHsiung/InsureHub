...
function HomePage({ setPolicyToEdit, setPolicyToView }) {
    ...
    const onDelete = async _id => {
        ...
        if (window.confirm(
            'Warning: Are you sure you want to delete this policy? This action is irreversible and will permanently remove all related data from the system. Please confirm your decision to proceed with deletion.'
            )) 
            {
                ...
                if (response.status === 204){
                    ...
                    alert("Successfully deleted the policy!");
                } else {
